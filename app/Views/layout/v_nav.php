        ...
        <?php if (session()->get('level') == 1) { ?>
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu" role="menu">
                    ...
                    <li><a href="<?= base_url('matkul') ?>">Mata Pelajaran</a></li>
                    <li><a href="<?= base_url('mahasiswa') ?>">Siswa</a></li>
                    <li><a href="<?= base_url('dosen') ?>">Guru</a></li>
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu" role="menu">
                    ...
                    <li><a href="<?= base_url('JadwalKuliah') ?>">Jadwal Pelajaran</a></li>
                </ul>
            </li>
